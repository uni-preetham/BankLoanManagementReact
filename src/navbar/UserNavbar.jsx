...
function UserNavbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      await fetch("http://localhost:8080/bankloanmanagementsystem/api/user/logout", { // Adjust the URL to match your backend
        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="collapsibleNavId">
            <ul className="navbar-nav me-auto mt-2 mt-lg-0">
              ...
              <li className="nav-item">
                <Link to="/user/loanlist" className="nav-link">Loans applied</Link>
              </li>
            </ul>
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                  <li>
                    <Link to="/user/editprofile" className="dropdown-item">
                      Edit Profile
                    </Link>
                  </li>
